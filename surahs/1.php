...
<html lang="en">
  <head>
    <title>Al-Faatiha [1] - الفاتحة Word By Word English Translation And Transliteration</title>
    <meta charset="utf-8" />
...
<?php 
    ...
    <div class="container">
      <div class="row full-surah" style="padding: 50px 0px 50px 0px"></div>
      <audio id="player"></audio>
      <div class="bottom-nav" id="bottom-nav">
        <div class="bottom-nav__inner">
          <div class="bottom-nav__item bottom-nav__item--prevsurah" style="visibility: hidden"></div>
          <div class="bottom-nav__item bottom-nav-surahplayer" title="Click to play/pause"><span class="play-pause-icon play-icon"></span><span class="bottom-nav-surahname">Al-Faatiha / الفاتحة / The Opening</span></div>
