    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-gold fixed-top">
      <div class="container">
        <a class="navbar-brand">
          Al-Munaafiqoon <span class="nav-slash">/</span> المنافقون <span class="nav-surahname-en"><span class="nav-slash">/</span> The Hypocrites</span></a
