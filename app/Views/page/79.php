    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-gold fixed-top">
      <div class="container">
        <a class="navbar-brand">
          An-Naazi'aat <span class="nav-slash">/</span> النازعات <span class="nav-surahname-en"><span class="nav-slash">/</span> Those who drag forth</span></a
